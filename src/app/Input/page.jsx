  ...
  return (
    <div className='w-full container mx-auto h-screen flex flex-col items-center justify-center gap-10 md:p-6'>
      ...
      <div className="input w-full h-full flex flex-row items-center justify-center gap-3">
        <input onKeyDown={handleKeyDown} onClick={handleKeyDown} className='p-2 shadow-sm shadow-black rounded-2xl h-16 w-full' type="text" value={inputValue} onChange={(e) => setInputValue(e.target.value)} placeholder='Ask Whatever You Think...' />
